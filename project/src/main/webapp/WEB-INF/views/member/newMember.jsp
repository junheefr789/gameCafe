...
<script type="text/javascript">
	$(function(){
		$("#newMemberForm").submit(function(){
			...
			if (!id||!pw||!pwCheck||!name||!year||!month||!day||!mail) {
				alert("빈칸이 존재하면 안됩니다");
				return false;
			}
			if (id.length<8) {
...
<body>
	<form id="newMemberForm" action="newMemberCheck.go" method="post">
	<table id="newMemberTable">
		<tr class="newMemberTr">
			<td class="newMemberTd" align="center">
				<input id="member_id" name="member_id" autocomplete="off" maxlength="12" placeholder="아이디를 써주세요">
			</td>
		</tr>
		<tr class="newMemberTr">
			<td class="newMemberTd" align="center">
		...
		<tr>
			<td align="center">
				<button id="newMemberGo">회원가입</button>
			</td>
		</tr>
	</table>
	</form>
